...
namespace Counselors_Connect.Controllers
{
    public class VisitsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("VisitID,StudentID,CounselorID,Date,Description,File,ParentsCalled,Length")] Visit visit)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("VisitID,StudentID,CounselorID,Date,Description,File,ParentsCalled,Length")] Visit visit)
        {
            if (id != visit.VisitID)
            {
                return NotFound();
